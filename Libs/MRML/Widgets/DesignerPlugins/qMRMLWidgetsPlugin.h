...
#include "qMRMLWidgetsConfigure.h" // For MRML_WIDGETS_HAVE_QT${QT_VERSION_MAJOR}, MRML_WIDGETS_HAVE_WEBENGINE_SUPPORT

// Qt includes
#ifdef MRML_WIDGETS_HAVE_QT${QT_VERSION_MAJOR}
