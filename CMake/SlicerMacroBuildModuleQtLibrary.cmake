...
macro(SlicerMacroBuildModuleQtLibrary)
  ...
  if(NOT EXISTS ${Slicer_LOGOS_RESOURCE})
    ...
    QT${QT_VERSION_MAJOR}_WRAP_CPP(MODULEQTLIBRARY_MOC_OUTPUT ${MODULEQTLIBRARY_MOC_SRCS} ${_moc_options})
    QT${QT_VERSION_MAJOR}_WRAP_UI(MODULEQTLIBRARY_UI_CXX ${MODULEQTLIBRARY_UI_SRCS})
    if(DEFINED MODULEQTLIBRARY_RESOURCES AND NOT MODULEQTLIBRARY_RESOURCES STREQUAL "")
      QT${QT_VERSION_MAJOR}_ADD_RESOURCES(MODULEQTLIBRARY_QRC_SRCS ${MODULEQTLIBRARY_RESOURCES})
    endif()
    QT${QT_VERSION_MAJOR}_ADD_RESOURCES(MODULEQTLIBRARY_QRC_SRCS ${Slicer_LOGOS_RESOURCE})
