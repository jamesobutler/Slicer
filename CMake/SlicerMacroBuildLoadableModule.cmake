...
macro(slicerMacroBuildLoadableModule)
  ...
  if(NOT EXISTS ${Slicer_LOGOS_RESOURCE})
    ...
    QT${QT_VERSION_MAJOR}_WRAP_CPP(LOADABLEMODULE_MOC_OUTPUT ${LOADABLEMODULE_MOC_SRCS} ${_moc_options})
    QT${QT_VERSION_MAJOR}_WRAP_UI(LOADABLEMODULE_UI_CXX ${LOADABLEMODULE_UI_SRCS})
    if(DEFINED LOADABLEMODULE_RESOURCES)
      QT${QT_VERSION_MAJOR}_ADD_RESOURCES(LOADABLEMODULE_QRC_SRCS ${LOADABLEMODULE_RESOURCES})
    endif()
    QT${QT_VERSION_MAJOR}_ADD_RESOURCES(LOADABLEMODULE_QRC_SRCS ${Slicer_LOGOS_RESOURCE})
